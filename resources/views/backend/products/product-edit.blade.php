...
@section('content')
    ...
    <section class="product_area">
        <div class="container-fluid">
            <div class="col-md-12">
                <h2 style="font-family: fantasy" class="text-center">Edit Products</h2><br><br>
                @if(session('message'))
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="controls  col-sm-6">
                            {{--{!! Form::select('category', $catName , ['class' => 'form-control']) !!}--}}
                            <select name="category">
                                @foreach ($categories as $key=>$value)

{{--                                    @if (isset($catName))--}}

                                        <option name="category" value="{{ $key }}" {{ ( $key == $catId) ? 'selected' : '' }}>
                                        {{$value}}
...
{{--                                    <option value="{{$category->id}}">{{$category->name}}</option>--}}
                ...
                <div class="form-group text-center">
                    ...
                    <br><br>
                    {!! Form::submit('Update Products', ['class' => 'btn btn-success']) !!}
