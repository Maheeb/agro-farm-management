...
@section('extra-css')
    <link rel="stylesheet" href="{{asset('frontend/css/buy-form.css')}}">
...
@section('content')
    ...
    <section class="buy_info_form_area">
...
{{--                                {{ session('message') }}--}}
                    ...
                    {!! Form::open(['method' => 'POST','action'=>'FrontHomeController@buyOrder','files'=>true]) !!}
                        {{csrf_field()}}
